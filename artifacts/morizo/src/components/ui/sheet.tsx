...
const sideInitial: Record<string, TargetAndTransition> = {
  top: { y: "-100%", opacity: 0 },
...
const sideExit: Record<string, TargetAndTransition> = {
  top: { y: "-100%", opacity: 0 },
  bottom: { y: "100%", opacity: 0 },
  left: { x: "-100%", opacity: 0 },
  right: { x: "100%", opacity: 0 },
        ...
        <AnimatePresence>
          {open && (
            <>
              ...
              >
                <motion.div
                  initial={sideInitial[resolvedSide]}
                  animate={{ x: 0, y: 0, opacity: 1 }}
                  exit={sideExit[resolvedSide]}
